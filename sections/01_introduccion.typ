...
Este proyecto es desarrollado por el grupo DEAL @DEAL (Data Engineering Applications Lab) de la Universidad de Sevilla. Adicionalmente, se colabora con la Dra. Lorena López-Cerero y la Dra. Marina Pulido, investigadoras expertas en microbiología del grupo de Resistencia a Antimicrobianos @LyM de la Universidad de Sevilla.
...
La resistencia bacteriana a los antibióticos constituye uno de los mayores retos actuales para la salud pública a nivel mundial @murray2022global. Este fenómeno amenaza con revertir décadas de avances médicos, haciendo que infecciones y enfermedades comunes, hoy en día tratables de forma sencilla, vuelvan a ser potencialmente mortales. En la actualidad, se estima que causa más de 1,14 millones de muertes anuales, y se espera que esta cifra supere los 8 millones en 2050, situándose entre las principales causas de mortalidad, por delante de enfermedades como el cáncer @who_amr.
...
En este contexto, las pruebas de sensibilidad antimicrobiana (antimicrobial susceptibility testing, AST) desempeñan un papel fundamental. Estas técnicas permiten determinar si un microorganismo es sensible o resistente a distintos antibióticos, orientando así la elección del tratamiento más adecuado @vanbelkum2019development. Tradicionalmente, los métodos de AST se basan en el aislamiento del microorganismo, su cultivo en laboratorio y su exposición a diferentes agentes antimicrobianos para evaluar su crecimiento o inhibición. Sin embargo, estos procedimientos presentan una limitación crucial: la necesidad de cultivo implica tiempos prolongados, oscilando entre varios días o incluso semanas. Este retraso en la obtención de resultados condiciona la toma de decisiones clínicas y puede demorar el inicio del tratamiento adecuado para el paciente, lo cual resulta especialmente crítico en casos de infecciones graves.

Ante estas limitaciones, la secuenciación del genoma completo, combinada con técnicas de predicción, ha emergido como una alternativa complementaria prometedora @boolchandani2019antimicrobial. Este enfoque permite analizar directamente la información genética del microorganismo para identificar patrones asociados a resistencia, reduciendo significativamente los tiempos de diagnóstico y facilitando una aproximación más rápida y eficaz al tratamiento.
...
Por un lado, el sistema proporciona funcionalidades orientadas a la gestión y transformación de datos biológicos, permitiendo la conversión entre distintos formatos de archivos ampliamente utilizados en genómica, como FASTQ, FASTA y anotaciones generadas mediante la herramienta _Bakta_. Estas utilidades facilitan etapas fundamentales del flujo de trabajo, como son el ensamblaje y la anotación del genoma, simplificando procesos que habitualmente requieren el uso de múltiples herramientas independientes y conocimientos técnicos especializados.
...
El @sec:contexto describe el contexto en el que se enmarca este proyecto, incluyendo una descripción del proceso de análisis genómico y la predicción de resistencia a antibióticos, así como una revisión de los retos y necesidades actuales en este ámbito.

El @sec:análisis se dedica al análisis del problema, detallando las herramientas disponibles en la situación actual, sus limitaciones, los usuarios y necesidades, el sistema propuesto y el conjunto de casos de uso, requisitos de información, requisitos funcionales y no funcionales que se han definido para el desarrollo del proyecto.

El @sec:diseño se centra en el diseño de la solución propuesta, incluyendo la arquitectura del sistema, los diagramas de clases, prototipos de interfaz y otros aspectos relevantes del diseño.
